...
namespace college_management_back.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SubjectID,CourseID,TeacherID,Description")] Subject subject)
        {
            ...
            ViewBag.CourseID = new SelectList(db.Courses, "CourseID", "Description", subject.CourseID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SubjectID,CourseID,TeacherID,Description")] Subject subject)
        {
            if (ModelState.IsValid)
            {
