...
namespace college_management_back.Controllers
{
    public class GradesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GradeID,StudentID,SubjectID,Value")] Grade grade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GradeID,StudentID,SubjectID,Value")] Grade grade)
        {
            if (ModelState.IsValid)
            {
